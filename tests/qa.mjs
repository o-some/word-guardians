...
async function runProfile(name, browserType, viewport, fullGameplay=false) {
  ...
  const expectedVersion='v1.9.3 · DAMAGE SCALE + READABLE UI';
  if (!(await page.locator('body').innerText()).includes(expectedVersion)) throw new Error(`${name}: v1.9.3 version not visible`);
