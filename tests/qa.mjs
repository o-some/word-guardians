...
async function runProfile(name, browserType, viewport, fullGameplay=false) {
  ...
  const expectedVersion='v1.9.2 · DAMAGE SCALE + READABLE UI';
  if (!(await page.locator('body').innerText()).includes(expectedVersion)) throw new Error(`${name}: v1.9.2 version not visible`);
